function [] = plot_allchans_CSD_byfreqs(csd_results)    
    ...
    class(csd_avg_2_5Hz_by_channel)  
    disp(csd_avg_2_5Hz_by_channel);
    ...
    call_topoplot_eeglab(csd_avg_2_5Hz_by_channel', csd_results.Chanlocs)  % plot the topomap using the random voltages and the channel locations from the EEG data file.
